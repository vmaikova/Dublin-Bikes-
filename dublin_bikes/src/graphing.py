...
def createGraph(stationNumber):
	...
	py.sign_in('sybsyb', 'GgsO9oSlyY3Kvy7u9Jtb')
	...
	data = [trace1,trace2]
	layout = go.Layout(title=station+': '+name, width=800, height=640, legend=dict(orientation="h"))
	fig = go.Figure(data=data, layout=layout)
	py.image.save_as(fig, filename='/Users/sybilla/Desktop/SE_GroupProject2018/GitHubUploads/DublinBikes/static/graphs/ST' + station + '.png')
